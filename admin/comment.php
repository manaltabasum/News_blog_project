                    ...
                    <div class="card">
                        ...
                        <div class="card-body " style="display:block;">
                            <table id="allstd" class="table">
                                ...
                                <?php
                                $sql = "SELECT * FROM comment WHERE status = 1 OR status = 2 ORDER BY  id DESC";
                                ...
                                <tr>
                                    ...
                                    <th>
                                      <?php $sql = "SELECT * FROM post WHERE post_id = '$cmt_post_id'";
                                    $all_comment= mysqli_query($db,$sql);
                                    while($row = mysqli_fetch_assoc($all_comment)){
                                        $post_id = $row['post_id'];
                                        $title = $row['title'];
                                    ...
                                    <th scope = "row">
                                        <?php if($status == 2){ ?>
                                            ...
                                            <?php
                                             ...
                                             elseif ($status == 1) {
                                               ?>
                                            <div class="badge badge-primary">Published
